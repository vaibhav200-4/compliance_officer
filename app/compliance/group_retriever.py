...
class ComplianceGroupRetriever:
    ...
    def __init__(
        ...
        *,
        ...
        # If a retriever wasn't explicitly injected, build one scoped
        # to document_id so this analysis run only ever sees chunks
        # from the policy that was just ingested for it.
        self.retriever = (
            retriever
            or ComplianceRetriever(document_id=document_id)
        )
        ...
        *,
        ...
        response = (
            ...
            .similarity_search_by_vector(
                ...
                top_k=top_k,
                filter=self.retriever._build_filter(),
            )
        )
